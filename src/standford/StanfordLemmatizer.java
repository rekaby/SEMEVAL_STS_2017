...
public String[] toknize(String documentText)
{
...
public String lemmatizeWord(String documentText)
{
    String lemmas="";// = new LinkedList<String>();
    // Create an empty Annotation just with the given text
    Annotation document = new Annotation(documentText);
    // run all Annotators on this text
    this.pipeline.annotate(document);
...
public static void main(String[] args) {
   ...
   // System.out.println(slem.lemmatize(text));
	...
	while (idata.hasMoreTokens()) {
		...
		System.out.println(str+"-"+slem.lemmatizeWord(str));
	}
	System.out.println(slem.toknize(text));
	System.out.println(slem.lemmatize(text));
